...
public class BlockLamp extends BlockColored implements IConnectedTexture {
	...
	public BlockLamp(int id, String name, String readableName){
		super("au_extras", id, name, readableName, ItemBlockLamp.class, Material.glass);
	}
	...
	public boolean canConnectTextures(int id, int meta, int side, BlockCoord neighbor){
		// must be same color of lamp to connect
