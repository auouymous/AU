...
public class GuiArmorOptions extends GuiScreen {
	...
	private void drawPositionX(){
		...
		this.ui.setX(this.ui.drawString(UI.ALIGN_CENTER, String.format("x: %d", Cfg.armor_hud_x), 0xffffff, 40));
	...
	private void drawPositionY(){
		...
		this.ui.setX(this.ui.drawString(UI.ALIGN_CENTER, String.format("y: %d", Cfg.armor_hud_y), 0xffffff, 40));
